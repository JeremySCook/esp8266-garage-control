...
const char* ssid = "xxxxxxxx"; //WIFI Name, WeMo will only connect to a 2.4GHz network.
...
IPAddress ip(192, 168, 0, xx); // where xx is the desired IP Address
IPAddress gateway(192, 168, 0, xx); // set gateway to match your network
IPAddress subnet(255, 255, 255, xx); // set subnet mask to match your network
